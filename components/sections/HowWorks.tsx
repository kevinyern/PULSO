  ...
  return (
    <section className="reveal" style={{ padding: 'clamp(4rem, 8vw, 7rem) clamp(1.25rem, 5vw, 2rem)', borderTop: '1px solid #2a2a2a', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
        ...
        <p style={{ color: '#999', fontSize: '1.05rem', lineHeight: 1.7, marginBottom: '4rem', maxWidth: '620px' }}>Cada proyecto es único. Te lo hacemos simple: investigamos fondo, diseñamos estrategia audiovisual específica para ti, ejecutamos con rigor, medimos y ajustamos. Obsesionados con resultados, no con horas.</p>
